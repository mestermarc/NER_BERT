...
Original file is located at
    https://colab.research.google.com/drive/1XA9ShxIcb4CFYkIVZxm71INkZV2VckAk
"""
...
FILEPATH = '/content/drive/MyDrive/szovegesweb/my_train_NER.csv'
...
def get_preds(model, path, epoch):
...
MODELPATH = '/content/drive/MyDrive/szovegesweb/model/bertmodel_1.pkl'
model2 = BertModel()
tokenizer = BertTokenizerFast(tokenizer_file='/content/drive/MyDrive/szovegesweb/model/tokenizer.json/tokenizer.json')
